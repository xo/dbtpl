// Package sqlserver contains generated code for schema 'northwind'.
package sqlserver
...
func (c *Category) Upsert(ctx context.Context, db DB) error {
	...
	// upsert
	const sqlstr = `MERGE northwind.categories AS t ` +
		`USING (` +
		`SELECT @p1 category_id, @p2 category_name, @p3 description, @p4 picture ` +
		`) AS s ` +
