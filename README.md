...
```sh
$ go get -u github.com/classmarkets/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/classmarkets/xo
```
...
$ cp "$GOPATH/src/github.com/classmarkets/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/classmarkets/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/classmarkets/xo
```
